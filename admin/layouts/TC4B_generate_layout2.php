...
function TC4B_generate_layout2($name,$dir,$page_option){
   	$basedir = TC4B_generate_layout_std($name,$dir,$page_option);
    TC4B_copydir(theme_dir.'/images/Layout2',$basedir.'/themes/'.$dir);
...
<div class='flex-container pt-5 pb-5 pl-1 pr-1 pl-md-5 pr-md-5'>
    ...
    <div class= 'container'>
        ...
        <?php while ( \$wpb_all_query->have_posts() ) : \$wpb_all_query->the_post(); ?>
        	<div class='pb-3 pt-3 pl-1 pr-1 pl-md-3 pr-md-3 col-12 col-md-6'>
